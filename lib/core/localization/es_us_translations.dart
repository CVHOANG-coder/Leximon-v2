...
const esUsTranslations = <String, String>{
  ...
  "deleteAccountBody":
      "Al eliminar tu cuenta, se borrarán permanentemente tus datos guardados y tu progreso. Esta acción no se puede deshacer.",
  "deleteAccountConfirm": "Eliminar cuenta",
  "deleteAccountConfirmMessage":
      "¿Seguro que quieres eliminar tu cuenta? Todos tus datos y tu progreso se borrarán permanentemente.",
  "deleteAccountConfirmTitle": "¿Eliminar cuenta?",
  "deleteAccountError": "No se pudo eliminar la cuenta. Inténtalo de nuevo.",
  "iapProductUnavailable": "Este producto no está disponible en este momento.",
  "iapPurchaseBusy": "Ya hay una compra en proceso. Espera un momento.",
  "iapPurchaseFailed": "No se pudo completar la compra. Inténtalo de nuevo.",
  "iapStoreUnavailable":
      "La tienda de aplicaciones no está disponible en este momento. Inténtalo de nuevo más tarde.",
  "iapVerificationFailed":
      "No se pudo verificar la compra. Inténtalo de nuevo.",
  "ipaDataIncomplete": "Los datos de pronunciación están incompletos.",
  "ipaLoadedAudio": "Audio cargado.",
  "ipaLoadingAudio": "Cargando audio...",
  "ipaPreloadSubtitle":
      "Estamos preparando los archivos de audio de pronunciación para que la experiencia sea más fluida.",
  "ipaPreloadTitle": "Preparando audio",
  "ipaReadingData": "Cargando datos de pronunciación...",
  "listeningPackAnytime": "Aprende cuando quieras",
  "listeningPackBuy": "Comprar paquete",
  "listeningPackDescription":
      "Mejora tu comprensión auditiva con lecciones y ejercicios prácticos de inglés.",
  "listeningPackForever": "Acceso de por vida",
  "listeningPackLater": "Más tarde",
  "listeningPackLoading": "Cargando paquete...",
  "listeningPackOneTime": "Pago único",
  "listeningPackPurchaseError":
      "No se pudo completar la compra. Inténtalo de nuevo.",
  "listeningPackSave": "Ahorra más",
  "listeningPackSecure": "Pago seguro",
  "listeningPackTitle": "Paquete de comprensión auditiva",
  "listeningPackUnavailable":
  ...
  "saleBenefitProgress": "Sigue todo tu progreso",
  "saleBenefitUnlock": "Desbloquea todas las lecciones y funciones",
  "saleBigSaving": "Ahorra más con el plan anual",
  "saleChooseAfterTrial": "Elige tu plan después del período de prueba",
  "saleHeadlineDays": "{days} días",
  "saleHeadlinePrefix": "Prueba Pro gratis durante",
  "saleHeadlineSubtitle":
      "Desbloquea todas las lecciones y aprende sin anuncios.",
  "saleLater": "Ahora no",
  "saleLoadError":
      "No se pudieron cargar las opciones de suscripción. Inténtalo de nuevo.",
  "saleMonthlyPlan": "Plan mensual",
  "salePackageUnavailable": "Este paquete no está disponible en este momento.",
  "salePerMonth": "al mes",
  "salePerWeek": "a la semana",
  "salePerYear": "al año",
  "salePopular": "Más popular",
  "salePurchaseError": "No se pudo completar la compra. Inténtalo de nuevo.",
  "saleSaveAmount": "Ahorra {amount}",
  "saleSecurePayment": "Pago seguro a través del App Store",
  "saleStartTrial": "Iniciar prueba gratis",
  "saleTrialDays": "{days} días de prueba gratis",
  "saleWeeklyPlan": "Plan semanal",
  "skillPackBuy": "Comprar paquete",
  "skillPackForever": "Acceso de por vida",
  "skillPackGrammarBenefit": "Domina la gramática paso a paso",
  "skillPackGrammarDescription":
      "Practica la gramática del inglés con lecciones y ejercicios organizados por nivel.",
  "skillPackGrammarTitle": "Paquete de gramática",
  "skillPackGrammarUnlock": "Desbloquear paquete de gramática",
  "skillPackLater": "Más tarde",
  "skillPackListeningBenefit": "Mejora tu comprensión del inglés hablado",
  "skillPackListeningDescription":
      "Entrena tu oído con ejercicios prácticos y variados de comprensión auditiva en inglés.",
  "skillPackListeningTitle": "Paquete de comprensión auditiva",
  "skillPackListeningUnlock": "Desbloquear paquete de comprensión auditiva",
  "skillPackLoading": "Cargando paquete...",
  "skillPackOneTime": "Pago único",
  "skillPackPurchaseError":
      "No se pudo completar la compra. Inténtalo de nuevo.",
  "skillPackReadingBenefit": "Mejora tu velocidad y comprensión de lectura",
  "skillPackReadingDescription":
      "Desarrolla tu comprensión de lectura con textos y ejercicios adaptados a tu nivel.",
  "skillPackReadingTitle": "Paquete de lectura",
  "skillPackReadingUnlock": "Desbloquear paquete de lectura",
  "skillPackSave": "Ahorra más",
  "skillPackSecure": "Pago seguro",
  "skillPackSpeakingBenefit":
      "Habla con más confianza y mejora tu pronunciación",
  "skillPackSpeakingDescription":
      "Practica expresión oral y pronunciación con ejercicios prácticos que te ayudarán a usar el inglés con más confianza.",
  "skillPackSpeakingTitle": "Paquete de expresión oral",
  "skillPackSpeakingUnlock": "Desbloquear paquete de expresión oral",
  "skillPackUnavailable": "Este paquete no está disponible en este momento.",
  "subscriptionBenefitProgress":
      "Sigue tu progreso y aprende de forma más inteligente",
  "subscriptionBenefitQuality": "Contenido y ejercicios de alta calidad",
  "subscriptionBenefitUnlimited": "Acceso ilimitado a todas las lecciones",
  "subscriptionPrivacy": "Política de privacidad",
  "subscriptionRestore": "Restaurar compras",
  "subscriptionRestoreError":
      "No se pudieron restaurar tus compras. Inténtalo de nuevo.",
  "subscriptionRestoreStarted": "Restaurando tus compras...",
  "subscriptionSavingPercent": "Ahorra un {percent} %",
  "subscriptionTerms": "Términos de uso",
