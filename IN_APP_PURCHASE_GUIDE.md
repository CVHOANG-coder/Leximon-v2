...
- You are signed in to the App Store or Google Play with an account that can make purchases.
...
1. Complete the introductory language, level, and learning-goal steps.
2. Continue until the subscription screen appears.
3. Review the available plans. Depending on the current catalog, the app may offer weekly, monthly, annual, or other subscription periods.
4. Tap the plan you want. The selected plan is marked on the screen.
...
2. Tap the **VIP crown** icon in the upper-right corner.
3. Review the plans available to your account.
...
1. From **Home**, tap the **VIP crown** icon.
2. Your current plan is shown at the top of the subscription screen.
3. Select one of the longer plans offered as an upgrade.
4. Tap the upgrade button.
5. Review the billing change in the App Store or Google Play sheet, then confirm it.
6. Wait for the message: **Transaction successful. Your plan has been updated.**

Only valid upgrades are displayed. For example, a weekly subscriber may be offered monthly or annual plans, while a monthly subscriber may be offered an annual plan.

## Purchase an Individual Skill Pack

The following one-time packs are available when enabled in the current store catalog:

- Listening Practice Pack
- Speaking Practice Pack
- Reading Practice Pack
- Grammar Practice Pack
...
| --- | --- |
| Store is unavailable | Wait a few minutes, confirm that the App Store or Google Play is working, and try again. |
| Store connection was interrupted | Check Wi-Fi or mobile data, then retry. |
| Package is unavailable | Refresh or reopen the screen. The product may not be enabled for your platform, region, or account. |
| Another transaction is being processed | Wait for the current store sheet or transaction to finish before trying again. |
| Payment succeeded but verification failed | Do not immediately purchase again. Keep the app online, reopen it, and allow it to recover the unfinished transaction. Contact support if access is still missing. |
| You canceled the store sheet | No purchase is completed. Return to the package screen whenever you are ready. |

## Important Billing Notes

- The store confirmation sheet is the final source of truth for the amount charged, trial eligibility, billing period, renewal terms, taxes, and currency.
- Pro subscriptions are managed through the App Store or Google Play account used for the purchase.
